...
image: 'https://images.unsplash.com/photo-1522252234503-e356532cafd5?q=80&w=1200&h=800&auto=format&fit=crop'
tags: ['Astro', 'Fuwari', '前端开发', '博客魔改']
category: 博客魔改
draft: false 
lang: 'zh-CN'
order: 0
...
```php title="src/components/Navbar.astro"
---
...
```php title="src/components/widget/NavMenuPanel.astro"
---
import { Icon } from "astro-icon/components";
